...
Author-Ibin siby
date-19-10-2024
Discription- Python program that performs the following tasks:
...
result=(num1+num2)
print("The sum 0f num1 and num2 is:",result)
...
print("The result of (num1 + num2) * num3 / 2 is:", (num1 + num2) * num3 )